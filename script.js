...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ─── Subtitle fetching (server-side via Edge Function) ───────────────────
    ...
    async function fetchSubtitles(videoId) {
        ...
        // 2. Fetch server-side (niente CORS)
        console.log('Recupero sottotitoli dal backend...');
        ...
        // 3. Salva in cache DB se disponibile
        try {
